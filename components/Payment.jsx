  ...
  return (
    <div className={styles.container}>
      <div className={styles.wrapper}>
        ...
        <input placeholder='Enter your fullname' type="text" className={styles.fullName} id='fullName' onChange={()=>setCustomer(e.target.value)}/>
        <label htmlFor="phone" className={styles.label}>Phone number</label>
        <input placeholder='Enter your phone number' type="text" className={styles.fullName} id='phone' />
        <label htmlFor="address" className={styles.label} onChange={()=>setAddress(e.target.value)}>Address</label>
